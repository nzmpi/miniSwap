...
contract Deployment is Script {
  function run() public {
    ...
    uint256 token1Balance = 5000 ether + 42 ether;
    int24 tick = 85176;
    uint160 sqrtP = 5602277097478614198912276234240;

    vm.startBroadcast();
      ERC20Test token0 = new ERC20Test("token0", "t0", 18);
      ERC20Test token1 = new ERC20Test("token1", "t1", 18);
